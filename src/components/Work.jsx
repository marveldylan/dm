                        ...
                        <div className="Project-grid">
                            <div className="Project-card Dark">
                                ...
                                <div className="Project-about">
                                    ...
                                    <div className="Project-links">
                                        <p className="Link"><a href="https://project-indigo-front-end.herokuapp.com/" target="_blank">Deployed Project</a></p>
                                        <p className="Link"><a href="https://github.com/marveldylan/indigo-front-end" target="_blank">Github Front End</a></p>
                                        <p className="Link"><a href="https://github.com/marveldylan/indigo-back-end" target="_blank">Github Back End</a></p>
                                    </div>
                                </div>
                                <div className="Project-tech Light">
                            ...
                            <div className="Project-card Dark">
                                ...
                                <div className="Project-about">
                                    ...
                                    <div className="Project-links">
                                        <p className="Link"><a href="https://sleepy-inlet-25052.herokuapp.com/" target="_blank">Deployed Project</a></p>
                                        <p className="Link"><a href="https://github.com/marveldylan/medici" target="_blank">Github</a></p>
                                    </div>
                                </div>
                                <div className="Project-tech Light">
                                    <img className="Tech-logo" src={process.env.PUBLIC_URL + "icons8-mongodb.svg"} alt="MongoDB" />
                            ...
                            <div className="Project-card Dark">
                                ...
                                <div className="Project-about">
                                    ...
                                    <div className="Project-links">
                                        <p className="Link"><a href="https://ancient-atoll-31198.herokuapp.com/" target="_blank">Deployed Project</a></p>
                                        <p className="Link"><a href="https://github.com/ayyyecraig/turismo-front-end" target="_blank">Github Front End</a></p>
                                        <p className="Link"><a href="https://github.com/kibathi218/Carvana-Clone-Formula2-GranTurismo-SOmethingElse" target="_blank">Github Back End</a></p>
                                    </div>
                                </div>
                                <div className="Project-tech Light">
                            ...
                            <div className="Project-card Dark">
                                ...
                                <div className="Project-about">
                                    ...
                                    <div className="Project-links">
                                        <p className="Link"><a href="https://battleducks-dm.surge.sh/" target="_blank">Deployed Project</a></p>
                                        <p className="Link"><a href="https://github.com/marveldylan/BATTLEDUCKS" target="_blank">Github</a></p>
                                    </div>
                                </div>
                                <div className="Project-tech Light">
                                    <img className="Tech-logo" src={process.env.PUBLIC_URL + "icons8-html-5.svg"} alt="HTML" />
