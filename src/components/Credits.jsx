...
const Credits = () => {
    ...
    return (
        <div className="Credits-container Dark">
            <div></div>
            <div className="Credits-content">
                ...
                <a target="_blank" href="https://icons8.com/icon/rHpveptSuwDz/json-web-token">JSON Web Token</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a>

                <a target="_blank" href="https://icons8.com/icon/66728/circled-e">Circled E</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a>
                ...
                <a target="_blank" href="https://icons8.com/icon/la2tQEGz-gNl/redux">Redux</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a>
            </div>
            <div></div>
        </div>
    )
